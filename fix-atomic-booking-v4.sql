-- Corrigir função de agendamento atômico v4
-- Adiciona cast para booking_type enum
...
BEGIN
  ...
  -- 2. Verificar conflitos de agendamento usando EXISTS
  SELECT EXISTS (
    SELECT 1
    FROM bookings
    WHERE (
  ...
  INSERT INTO bookings (
    ...
    p_booking_date,
    p_booking_time,
    p_service_type::booking_type, -- Cast para o tipo enum correto
    p_client_name,
    p_client_email,
    p_client_phone,
    p_client_address,
