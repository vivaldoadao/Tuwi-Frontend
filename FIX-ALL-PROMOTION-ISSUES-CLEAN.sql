-- ==========================================
-- FIX ALL PROMOTION SYSTEM ISSUES - CLEAN VERSION
-- Execute este SQL para corrigir todos os problemas (remove políticas existentes primeiro)
-- ==========================================

-- 1. Primeiro, remover políticas RLS existentes para evitar conflitos
...
-- 2. Criar tabela promotion_packages se não existir
...
-- 3. Criar tabela promotions se não existir (com relacionamento correto)
...
-- 4. Criar tabela promotion_transactions se não existir
...
-- 5. Criar tabela promotion_analytics se não existir
...
-- 6. Inserir pacotes de exemplo se não existirem
...
-- 9. Criar políticas RLS (versão limpa)
